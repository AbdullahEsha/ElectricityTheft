  ...
  <nav id="sidebar" class="sidebar-wrapper">
    <div class="sidebar-content">
      ...
      <div class="sidebar-header">
        <div class="user-pic"><a href="distributorPage.php"><img class="img-responsive img-rounded" src="../assets/image/<?=$_SESSION['img']?>"
            alt="User picture"></a>
        </div>
        <div class="user-info">
  ...
  <main class="page-content">
    <div class="container-fluid">
        ...
        <div class="table-hover table-responsive" id="table1">
          ...
          <tbody align="center">
          <?php
		  $theft = getTheftNotification();
		  for ($i=0; $i != count($theft); $i++) {  ?>
            <tr>
              <td><?=$theft[$i]['id']?></td>
              <td><?=$theft[$i]['location']?></td>
              <td><?=$theft[$i]['dateTime']?></td>
            </tr>
          <?php } ?>
          </tbody>
          </table>
